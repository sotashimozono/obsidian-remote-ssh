...
func startTestServer(t *testing.T) *testServer {
	...
	disp.Handle("fs.write", handlers.RequireAuth(handlers.FsWrite(vaultRoot, nil)))
	disp.Handle("fs.writeBinary", handlers.RequireAuth(handlers.FsWriteBinary(vaultRoot, nil)))
